...
ACTION_DEFINITIONS = {
    ...
    "start_mower": {
        "description": "Start mowing the lawn with the robot lawnmower (komanda pjauti žolę, paleisti žoliapjovę, pvz. 'paleisk žoliapjovę', 'pjauk žolę')",
        "service": "lawn_mower.start_mowing",
    },
    "pause_mower": {
        "description": "Pause or stop the robot lawnmower (komanda sustabdyti žoliapjovę, pvz. 'sustabdyk žoliapjovę', 'pristabdyk')",
        "service": "lawn_mower.pause",
    },
    "dock_mower": {
        "description": "Send the robot lawnmower back to its dock or base (komanda grąžinti žoliapjovę į stotelę, pvz. 'grąžink žoliapjovę į stotelę', 'žoliapjove grįžk namo')",
...
ACTION_COMPATIBLE_DOMAINS: dict[str, set[str] | None] = {
    "turn_on": {"light", "switch", "fan", "climate", "media_player", "vacuum", "lawn_mower", "area"},
    "turn_off": {"light", "switch", "fan", "climate", "media_player", "vacuum", "lawn_mower", "area"},
    "toggle": {"light", "switch", "fan", "area"},
    "open_cover": {"cover", "area"},
    "close_cover": {"cover", "area"},
    "start_vacuum": {"vacuum", "lawn_mower", "area"},
    "stop_vacuum": {"vacuum", "lawn_mower", "area"},
    "dock_vacuum": {"vacuum", "lawn_mower", "area"},
    "start_mower": {"lawn_mower", "area"},
    "pause_mower": {"lawn_mower", "area"},
    "dock_mower": {"lawn_mower", "area"},
...
LOCALIZED_RESPONSES = {
    "en": {
        ...
        "start_mower": "Mowing started",
        "pause_mower": "Mower paused",
        "dock_mower": "Returning to dock",
        "media_play": "Playing",
        "media_pause": "Paused",
    ...
    "lt": {
        ...
        "start_mower": "Žoliapjovė paleista",
        "pause_mower": "Žoliapjovė sustabdyta",
        "dock_mower": "Žoliapjovė grįžta į stotelę",
        "media_play": "Paleista",
